...
func TestClient_addAgentStatus_Success(t *testing.T) {
	c, mockHTTP, _ := newTestClient()
...
func TestClient_addAgentStatus_HTTPError(t *testing.T) {
	c, mockHTTP, _ := newTestClient()
...
func TestClient_addAgentStatus_Non200Status(t *testing.T) {
	tests := []struct {
		name       string
		statusCode int
	}{
...
func TestClient_addAgentStatus_ValidationError(t *testing.T) {
	c, _, _ := newTestClient()
...
func TestClient_addAgentStatus_NewRequestError(t *testing.T) {
	mockHTTP := newMockHTTPClient()
	fakeClock := clockwork.NewFakeClock()
